...
const CVPage: React.FC = () => {
  ...
  const downloadPDF = useCallback(async () => {
    ...
    try {
      ...
      const pageW = 210;
      const pageH = 297;
      const width = page1Ref.current.offsetWidth;
      const height = page1Ref.current.offsetHeight;

      // Render Page 1 to PNG with explicit dimensions
      ...
      // Render Page 2 to PNG with explicit dimensions
      const p2Url = await domToPng(page2Ref.current, {
        scale: 2,
        width: page2Ref.current.offsetWidth,
        height: page2Ref.current.offsetHeight,
        backgroundColor: "#ffffff",
        style: {
          boxShadow: "none",
          border: "none",
      ...
      pdf.setFontSize(8);
      pdf.setTextColor(255, 255, 255); // White - invisible visually, readable by ATS
    ...
    <div className="min-h-screen bg-background selection:bg-primary/30 selection:text-primary">
      <div className="pt-16 pb-16 px-4 md:px-8">
        ...
        <div className="w-full overflow-x-auto py-4">
          <div className="flex flex-col items-center gap-8 min-w-[210mm] w-full px-4 mx-auto">
                          ...
                          <h3 className="text-xs font-bold text-gray-900">
                            ...
                            {project.demoUrl && (
                              <a
                                ...
                                className="text-[10px] text-blue-600 hover:underline font-normal ml-2"
                              >
                                {project.demoUrl}
                              </a>
                            )}
