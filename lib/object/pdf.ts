...
export const ABOUT: string = `Fullstack Web Developer with hands-on experience in building modern, responsive web applications using React, Next.js, Node.js, and TypeScript. Proficient in front-end development with React and Next.js, back-end development with Node.js and Express.js, database management with PostgreSQL and Prisma ORM, and cloud deployment with Vercel, DigitalOcean, dan Railway. Experienced in REST API integration, state management with Zustand, Ui/UX design, and unit/integration testing with Jest. Passionate about clean code, modular architecture, and delivering high-quality user experiences.`;
...
export const EDUCATION_LIST: Education[] = [
  ...
  {
    school: "SMK Pesantren",
    location: "Sungai Pinang, Kota Samarinda, Indonesia",
    major: "Tehnik Jaringan dan Informatika",
    date: "2019 – 2022",
  },
];
